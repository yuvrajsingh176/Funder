...
interface FundCardProps {
  ...
  title: string;
  description: string;
  target: string | number; // Assuming target can be a string or number
  deadline: string; // Assuming deadline is a string (e.g., date in ISO format)
  amountCollected: string | number; // Assuming amountCollected can be a string or number
  image: string;
  handleClick: () => void; // Function type for the click handler
}
